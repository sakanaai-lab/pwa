// appLogic（Phase 1 で app.js から抽出）。挙動は不変。
import { ANTHROPIC_MODELS, APP_VERSION, BEDROCK_MODELS, CHATS_STORE, DEEPSEEK_API_BASE_URL, DEEPSEEK_MODELS, DEFAULT_ANTHROPIC_MODEL, DEFAULT_BEDROCK_MODEL, DEFAULT_DEEPSEEK_MODEL, DEFAULT_GROQ_MODEL, DEFAULT_MISTRAL_MODEL, DEFAULT_MODEL, DEFAULT_OPENAI_MODEL, DEFAULT_OPENROUTER_MODEL, DEFAULT_XAI_MODEL, DEFAULT_ZAI_MODEL, DUPLICATE_SUFFIX, GEMINI_API_BASE_URL, GEMINI_MODELS, GROQ_API_BASE_URL, GROQ_MODELS, IMAGE_STORE, IMPORT_PREFIX, INITIAL_RETRY_DELAY, MAX_FILE_SIZE, MAX_PROFILES, MAX_TOTAL_ATTACHMENT_SIZE, MISTRAL_API_BASE_URL, MISTRAL_MODELS, OPENAI_MODELS, OPENROUTER_API_BASE_URL, SETTINGS_STORE, SWIPE_THRESHOLD, VERSION_ACK_STORAGE_KEY, VERSION_HISTORY, VERSION_LEGACY_STORAGE_KEY, VERSION_NOTICE_SESSION_KEY, XAI_API_BASE_URL, XAI_MODELS, ZAI_API_BASE_URL, ZAI_MODELS, ZOOM_THRESHOLD } from './constants.js';
import { DebugLogger } from './debug-logger.js';
import { apiUtils } from './api.js';
import { formatFileSize, interruptibleSleep, sleep } from './utils/format.js';
import { broadcastChannel, registerServiceWorker, setupBroadcastChannel, updateMessageMaxWidthVar } from './app.js';
