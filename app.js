...
※iPhoneのHEIC画像は、設定→カメラ→フォーマットを「互換性優先」に変更するか、変換アプリをご利用ください。`);
  ...
  __name(isWebKitBrowser, "isWebKitBrowser");
  ...
  __name(createCaptureCanvas, "createCaptureCanvas");
  ...
  __name(drawElementBox, "drawElementBox");
  ...
  __name(drawTextNode, "drawTextNode");
  ...
  __name(canDrawImageWithoutTaint, "canDrawImageWithoutTaint");
  ...
  __name(drawDomNode, "drawDomNode");
  ...
  __name(messageElementToCanvasBlob, "messageElementToCanvasBlob");
  ...
  async function shareOrDownloadImage(blob, filename) {
    ...
    if (shareData && typeof navigator.share === "function" && typeof navigator.canShare === "function") {
      try {
